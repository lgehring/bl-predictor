...
def get_df(end_date, current_date):
    """
    Takes data from csv file, concat the missing data and save new data.
    If there is no csv file yet the function will take all from the "internet"
...
def get_last_date(df):
    """
    Finds the matchday and season of the last match in the df.
...
def take_data(start_date, ending_date, df):
    ...
    :return: Dataframe. It begins and ends with january and
     december, not first and last matchday
    """
